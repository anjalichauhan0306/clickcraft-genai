        ...
        <footer className="flex flex-wrap justify-center md:justify-between overflow-hidden gap-10 md:gap-20 mt-40 py-6 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500">
            ...
            >
                ...
                <div className="flex items-center gap-4 mt-3">
                    ...
                    <a href="www.linkedin.com/in/anjali-chauhan-22b93430a" target="_blank" rel="noreferrer">
                ...
                <p className="mt-3 text-center">&copy; {new Date().getFullYear()} <a href="https://prebuiltui.com?utm_source=pixels">Thumblity</a></p>
            </motion.div>
        </footer>
    );
}